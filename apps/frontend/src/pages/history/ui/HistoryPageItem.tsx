...
import type { ResumeAnalyzedResponse } from "@/shared/api";
import { routes } from "@/shared/config/routes";

export const HistoryPageItem: React.FC<{
  historyItem: ResumeAnalyzedResponse;
}> = ({ historyItem }) => {
  if (!historyItem.request_id) return;
  return (
    <Card>
      <Stack>
        ...
        <Button
          ...
          to={routes.shell.historyItem.$buildPath({
            params: { historyItemId: historyItem.request_id },
          })}
          size="md"
